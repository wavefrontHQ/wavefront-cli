...
def get_proxy_install_cmd(proxy_next):
    ...
    print "Detected ", dist
    if dist.strip() == "Fedora" or dist == "Amazon Linux AMI" or dist == "Red Hat Enterprise Linux Server" or dist == "Red Hat Enterprise Linux Workstation" or dist == "CentOS" or dist == "CentOS Linux":
